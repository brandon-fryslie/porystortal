...
isTagNameInList = (element, list) ->
  _.contains list, element.tagName.toUpperCase()
...
findViewportAndContent = (startElement) ->
  ...
  # for e = startElement.parent().parent()[0]; e isnt root; e = e.parentNode
  #   # is element
  ...
  #   # and no text
  #   for n = e.firstChild; n; n.nextSibling
